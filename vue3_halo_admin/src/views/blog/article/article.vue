        ...
        <n-form :model="state.rowData"
            ...
            <div class="halo-edit-left">
              <div>
                ...
                <n-form-item label="分类">
                  <n-select :options="state.sortMap"
          ...
          <n-form-item label="内容">
            <n-input
              ...
              v-model:value="state.rowData.content"
              type="textarea"
            />
          </n-form-item>
          ...
          <div class="article-button">
            <div>
              ...
              <n-button class="article-button-item" type="error" @click="deleteArticle">删除
              </n-button>
            </div>
            <div>
